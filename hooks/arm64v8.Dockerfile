...
RUN ln /usr/lib/aarch64-linux-gnu/libcrypto.a /friendup/libs-ext/openssl/libcrypto.a &&\
    ln /usr/lib/aarch64-linux-gnu/libssl.a /friendup/libs-ext/openssl/libssl.a
RUN cd /friendup &&\
    make setup &&\
